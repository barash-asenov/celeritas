...
func (v *Validation) IsInt(field, value string) {
	 ...
	 if err != nil {
		 v.AddError(field, "This field must be integer")
	 }
}
...
func (v *Validation) IsFloat(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must be floating point number")
	}
}
...
func (v *Validation) IsDateISO(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must be a date in the format of YYYY-MM-DD")
	}
}
