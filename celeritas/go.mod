module github.com/barash-asenov/celeritas
...
require (
	...
	github.com/ainsleyclark/go-mail v1.0.0
	...
	github.com/alexedwards/scs/redisstore v0.0.0-20211203064041-370cc303b69f
